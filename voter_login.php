...
<center>
    ...
    <table>
        ...
        <tr><td><?php
                if(isset($_GET["erno"])) echo "The voter is not registered"; if(isset($_GET["alr"])) echo "You have already voted"; if(isset($_REQUEST["er"])) echo "Incorrect Pin";?></td><td><input type="submit" value="LOGIN"></td></tr>
    </table>
    </form>
</center>
<?php
